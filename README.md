...
**Live → https://baditaflorin.github.io/mesh-tag/**

**Source → https://github.com/baditaflorin/mesh-tag**
...
git clone https://github.com/baditaflorin/mesh-tag
cd mesh-tag
npm install
npm run dev
```
...
- `mesh-tag:signalingUrl`
- `mesh-tag:turnTokenUrl`
- `mesh-tag:iceServers`
- `mesh-tag:room`
